...
if(isset($_POST['register'])){
    ...
    $insert_customer = "insert into customers (customer_name,customer_email,customer_pass,customer_state,customer_district,customer_contact,customer_address,customer_image,customer_ip,is_manufacturer,created_at) values ('$c_name','$c_email','md5($c_pass)','$c_state','$c_district','$c_contact','$c_address','$c_image','$c_ip','0',NOW())";
